...
export function buildProfileTags(p: UserProfile): string[] {
  const tags: string[] = [];
  const chosenPalettes = COLOR_PALETTES.filter(c => p.colors.includes(c.value));
  for (const palette of chosenPalettes) {
    tags.push(palette.label, ...palette.tags);
  }
  const chosenEnvironments = ENVIRONMENT_SCENES.filter(e => p.environments.includes(e.value));
  for (const env of chosenEnvironments) tags.push(env.label);
  const worldLabel = WORLD_OPTIONS.find(w => w.value === p.world)?.label;
  if (worldLabel) tags.push(worldLabel);
  const aestheticLabels = AESTHETIC_OPTIONS.filter(a => p.aesthetic.includes(a.value)).map(a => a.label);
  tags.push(...aestheticLabels);
  return tags;
}
...
const COLOR_PALETTES = [
  { label: "Carmine",        value: "carmine",        colors: ["#9E0031", "#770058", "#600047", "#44001A"], featured: true,  tags: ["intensity", "drama", "power dressing", "jewel tones", "theatrical"],          meaning: "this client is drawn to intensity and drama — they want fashion that makes a statement, commands a room and is unafraid of power. Recommend pieces with presence: deep jewel tones, strong silhouettes, garments with theatrical weight" },
  { label: "Grande Dame",    value: "grande-dame",    colors: ["#39181D", "#96031A", "#FDC55E", "#BFBFC5"], featured: true,  tags: ["glamour", "old Hollywood", "maximalist dressing", "theater", "velvet & silk"], meaning: "this client lives for glamour — old Hollywood, red carpet moments, vintage Versace and maximalist dressing. They believe more is more. Recommend statement pieces, rich fabrics like velvet and silk, bold jewel tones, gold accents and designers who understand theater" },
  { label: "Bare Silk",      value: "bare-silk",      colors: ["#D98877", "#E19D94", "#EEC5AF", "#FCE5D9"], featured: false, tags: ["quiet luxury", "old money", "cashmere", "tonal dressing", "understated"],      meaning: "this client is drawn to quiet luxury and old money sensibility — they wear cashmere, carry nothing logo, and dress with an understated confidence that needs no announcement. Recommend tonal dressing in warm nudes and blush roses, impeccable tailoring, heritage labels and pieces that whisper rather than shout" },
  { label: "Velvet Rose",    value: "velvet-rose",    colors: ["#0F110C", "#9D6381", "#612940", "#FDECEF"], featured: true,  tags: ["classic", "dark romantic", "moody tones", "dusty rose", "timeless"],           meaning: "this client favors classic style with a dark romantic edge — they are elegant but not conventional, drawn to tradition with a shadow underneath it. Recommend timeless silhouettes in muted, moody tones: dusty rose, black, deep burgundy, and the occasional soft blush for contrast" },
  { label: "Indigo & Earth", value: "indigo-earth",   colors: ["#EF946C", "#C4A77D", "#70877F", "#2F2963"], featured: true,  tags: ["bohemian", "artisan craft", "natural materials", "global", "earthy"],           meaning: "this client lives a bohemian, earthy lifestyle — they are drawn to artisan craft, natural materials, global influences and unhurried dressing. Recommend flowing silhouettes, natural fibres, handmade or ethically-sourced pieces, and a palette rooted in earth and landscape" },
  { label: "Gilded",         value: "gilded",          colors: ["#221408", "#8B5A2B", "#C6A14A", "#ECE1C9"], featured: true,  tags: ["heritage luxury", "old money", "antique gold", "impeccable tailoring", "Hermès"], meaning: "this client is drawn to heritage luxury and old-money warmth — espresso, cognac, antique gold and champagne, the world of Hermès leather, Loro Piana cashmere and gilt. Richly warm tones that flatter deep and olive complexions especially. Recommend impeccable heritage tailoring, supple leather, camel and chocolate, gold rather than silver, and labels that wear their quality without a logo" },
  { label: "Understory",     value: "understory",      colors: ["#0D1F22", "#264027", "#6F732F", "#B38A58"], featured: false, tags: ["intellectual", "anti-trend", "forest tones", "independent labels", "utilitarian"], meaning: "this client is intellectual and inward-looking — they read widely, think deeply and are entirely indifferent to trends. They dress with quiet intention rather than to be seen. Recommend considered, unfussy pieces in forest tones: deep greens, aged bronze, dark teal. Think independent labels, utilitarian cuts, garments that age well" },
  { label: "Electric Noir",  value: "electric-noir",  colors: ["#0D0106", "#3626A7", "#657ED4", "#FF331F"], featured: true,  tags: ["nightlife", "city energy", "80s", "bold shoulders", "neon", "new wave"],         meaning: "this client lives for nightlife, city energy and the electric pulse of somewhere like New York — they are drawn to the 80s: bold shoulders, graphic contrast, neon against black. Recommend high-impact evening pieces, leather, strong color pops against dark foundations, and designers with an urban or new-wave sensibility" },
  { label: "Shore & Sail",   value: "shore-sail",     colors: ["#B3001B", "#245894", "#D3E0EE", "#CCAD8F"], featured: true,  tags: ["coastal", "preppy", "Nantucket", "sun-bleached linen", "Americana"],            meaning: "this client has a coastal, preppy sensibility — think Nantucket, sailing clubs, sun-bleached linen and effortless summer ease. Recommend classic Americana and European resort wear: navy and white stripes, crisp cotton, relaxed tailoring and a palette anchored in sea, sand and faded red" },
  { label: "Fête",           value: "fete",            colors: ["#ED254E", "#F9DC5C", "#C2EABD", "#011936"], featured: true,  tags: ["playful", "bright color", "color-blocking", "fun dressing", "uninhibited"],      meaning: "this client has a joyful, playful and uninhibited relationship with fashion — they enjoy bright color, fun dressing and experiences that feel bubbly and alive. Recommend bold color-blocking, playful prints, youthful silhouettes and designers who don't take themselves too seriously" },
  { label: "Ink & Ash",      value: "ink-ash",        colors: ["#FFFFFF", "#B8B8B8", "#45596E", "#0E1620"], featured: true,  tags: ["grayscale", "minimalist", "architectural", "Parisian restraint", "avant-garde"],  meaning: "this client lives in grayscale — a minimalist with a sharp, architectural eye, drawn to contrast, clean lines and the discipline of a monochrome wardrobe. Think Parisian restraint, avant-garde tailoring, the quiet authority of blue-black ink against stark white. Recommend impeccable cuts, graphic silhouettes, blue-black and cool slate, crisp whites and soft grays, and designers who prove the absence of color is its own statement" },
  { label: "Silver Mist",    value: "silver-mist",    colors: ["#878C8F", "#FCF7FF", "#655560", "#C4CAD0"], featured: false, tags: ["modern", "trend-aware", "polished", "clean lines", "effortless"],               meaning: "this client is chic, modern and trend-aware — they are polished, follow the right references and want to look current. They are somewhat predictable in the best sense: they trust the edit. Recommend well-positioned contemporary pieces, clean lines, and looks that read as effortlessly of-the-moment" },
];
